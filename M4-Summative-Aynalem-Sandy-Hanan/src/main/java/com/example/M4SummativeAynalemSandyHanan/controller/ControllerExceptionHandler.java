...
import com.example.M4SummativeAynalemSandyHanan.model.CustomErrorResponse;
...
import java.util.List;
    ...
    @RestControllerAdvice //a class to handle our errors in the controller
    public class ControllerExceptionHandler {
        ...
        // handles arithmetic exception when dividing by zero
